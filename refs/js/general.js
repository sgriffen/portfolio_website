...
function fixndChildById(element, id) {
	let i;
	let childNodes = element.childNodes;
...
function element_hide(elem) { elem.style.display = "none"; }
function element_display_block(elem) { elem.style.display = "block"; }
function element_display_inline(elem) { elem.style.display = "inline-block"; }
